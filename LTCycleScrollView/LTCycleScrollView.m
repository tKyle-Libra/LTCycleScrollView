...
#import "LTCycleScrollViewCell.h"
#import "LTCycleScrollViewFlowLayout.h"
#define kScreenWidth  [UIScreen mainScreen].bounds.size.width

@interface LTCycleScrollView()<UICollectionViewDataSource,UICollectionViewDelegate>
@property (nonatomic,strong) UIImageView *backgroundImageView;
@property (nonatomic,strong) LTCycleScrollViewFlowLayout *flowLayout;
...
{
    LTCycleScrollView *cycleScrollView = [[LTCycleScrollView alloc]initWithFrame:frame];
...
{
    LTCycleScrollViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellID forIndexPath:indexPath];
...
-(UICollectionView *)collectionView
{
    if(_collectionView == nil)
    {
        ...
        //注册cell
        [_collectionView registerClass:[LTCycleScrollViewCell class] forCellWithReuseIdentifier:cellID];
...
-(LTCycleScrollViewFlowLayout *)flowLayout
{
    if(_flowLayout == nil)
    {
        _flowLayout = [[LTCycleScrollViewFlowLayout alloc]init];
